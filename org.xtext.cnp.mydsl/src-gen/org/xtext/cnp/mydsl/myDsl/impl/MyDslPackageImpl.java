...
import org.xtext.cnp.mydsl.myDsl.MyDslFactory;
...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   * @generated
   */
  private EClass organizationalModelEClass = null;
   ...
   * @see org.xtext.cnp.mydsl.myDsl.MyDslPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * @generated
   */
  public EReference getModel_AgentAttributes()
  {
   ...
   * @generated
   */
  public EReference getModel_TaskAttributes()
  {
   ...
   * @generated
   */
  public EReference getModel_BidAttributes()
  {
   ...
   * @generated
   */
  public EReference getModel_ContractAttributes()
  {
   ...
   * @generated
   */
  public EReference getModel_OrganizationalModel()
  {
   ...
   * @generated
   */
  public EReference getModel_TasksModel()
  {
   ...
   * @generated
   */
  public EReference getModel_ContractNetProtocols()
  {
   ...
   * @generated
   */
  public EClass getOrganizationalModel()
  {
    return organizationalModelEClass;
  }
   ...
   * @generated
   */
  public EReference getOrganizationalModel_Agents()
  {
    return (EReference)organizationalModelEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getTasksModel_Tasks()
  {
    return (EReference)tasksModelEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getContractNetProtocol_Name()
  {
   ...
   * @generated
   */
  public EReference getContractNetProtocol_RoleBehavior()
  {
   ...
   * @generated
   */
  public EReference getRoleBehavior_StartState()
  {
    return (EReference)roleBehaviorEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getRoleBehavior_EndState()
  {
    return (EReference)roleBehaviorEClass.getEStructuralFeatures().get(4);
  }
   ...
   * @generated
   */
  public EReference getActivity_Declarations()
  {
   ...
   * @generated
   */
  public EReference getActivity_If()
  {
   ...
   * @generated
   */
  public EReference getActivity_Then()
  {
   ...
   * @generated
   */
  public EReference getActivity_Elseif()
  {
   ...
   * @generated
   */
  public EReference getActivity_Else()
  {
   ...
   * @generated
   */
  public EAttribute getActionStatement_Inputs()
  {
   ...
   * @generated
   */
  public EAttribute getAssertStatement_Input()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(modelEClass, MODEL__AGENT_ATTRIBUTES);
    createEReference(modelEClass, MODEL__TASK_ATTRIBUTES);
    createEReference(modelEClass, MODEL__BID_ATTRIBUTES);
    createEReference(modelEClass, MODEL__CONTRACT_ATTRIBUTES);
    createEReference(modelEClass, MODEL__ORGANIZATIONAL_MODEL);
    createEReference(modelEClass, MODEL__TASKS_MODEL);
    createEReference(modelEClass, MODEL__CONTRACT_NET_PROTOCOLS);
    ...
    organizationalModelEClass = createEClass(ORGANIZATIONAL_MODEL);
    createEReference(organizationalModelEClass, ORGANIZATIONAL_MODEL__AGENTS);
    ...
    createEReference(tasksModelEClass, TASKS_MODEL__TASKS);
    ...
    createEAttribute(contractNetProtocolEClass, CONTRACT_NET_PROTOCOL__NAME);
    createEReference(contractNetProtocolEClass, CONTRACT_NET_PROTOCOL__VARIABLES);
    createEReference(contractNetProtocolEClass, CONTRACT_NET_PROTOCOL__ROLE_BEHAVIOR);
    ...
    createEReference(roleBehaviorEClass, ROLE_BEHAVIOR__START_STATE);
    createEReference(roleBehaviorEClass, ROLE_BEHAVIOR__END_STATE);
    ...
    createEReference(activityEClass, ACTIVITY__DECLARATIONS);
    createEReference(activityEClass, ACTIVITY__IF);
    createEReference(activityEClass, ACTIVITY__THEN);
    createEReference(activityEClass, ACTIVITY__ELSEIF);
    createEReference(activityEClass, ACTIVITY__ELSE);
    ...
    createEAttribute(actionStatementEClass, ACTION_STATEMENT__INPUTS);

    assertStatementEClass = createEClass(ASSERT_STATEMENT);
    createEAttribute(assertStatementEClass, ASSERT_STATEMENT__INPUT);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getModel_AgentAttributes(), this.getClassAttributes(), null, "agentAttributes", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModel_TaskAttributes(), this.getClassAttributes(), null, "taskAttributes", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModel_BidAttributes(), this.getClassAttributes(), null, "bidAttributes", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModel_ContractAttributes(), this.getClassAttributes(), null, "contractAttributes", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModel_OrganizationalModel(), this.getOrganizationalModel(), null, "organizationalModel", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModel_TasksModel(), this.getTasksModel(), null, "tasksModel", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModel_ContractNetProtocols(), this.getContractNetProtocol(), null, "contractNetProtocols", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(organizationalModelEClass, OrganizationalModel.class, "OrganizationalModel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOrganizationalModel_Agents(), this.getAgent(), null, "agents", null, 0, -1, OrganizationalModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getTasksModel_Tasks(), this.getTask(), null, "tasks", null, 0, -1, TasksModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getContractNetProtocol_Name(), ecorePackage.getEString(), "name", null, 0, 1, ContractNetProtocol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getContractNetProtocol_RoleBehavior(), this.getRoleBehavior(), null, "roleBehavior", null, 0, -1, ContractNetProtocol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRoleBehavior_StartState(), this.getState(), null, "startState", null, 0, 1, RoleBehavior.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRoleBehavior_EndState(), this.getState(), null, "endState", null, 0, 1, RoleBehavior.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getState_Variables(), this.getVariable(), null, "variables", null, 0, -1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getActivity_Declarations(), this.getVariableDeclaration(), null, "declarations", null, 0, -1, Activity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getActivity_If(), this.getCondition(), null, "if", null, 0, 1, Activity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getActivity_Then(), this.getStatement(), null, "then", null, 0, -1, Activity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getActivity_Elseif(), this.getActivity(), null, "elseif", null, 0, 1, Activity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getActivity_Else(), this.getStatement(), null, "else", null, 0, -1, Activity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getActionStatement_Inputs(), ecorePackage.getEString(), "inputs", null, 0, -1, ActionStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getAssertStatement_Input(), ecorePackage.getEString(), "input", null, 0, 1, AssertStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
