 ...
 * <ul>
 *   <li>{@link org.xtext.cnp.mydsl.myDsl.impl.TasksModelImpl#getTasks <em>Tasks</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TasksModelImpl extends MinimalEObjectImpl.Container implements TasksModel
{
  ...
  public EList<Task> getTasks()
  {
    if (tasks == null)
    {
      tasks = new EObjectContainmentEList<Task>(Task.class, this, MyDslPackage.TASKS_MODEL__TASKS);
    }
    return tasks;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.TASKS_MODEL__TASKS:
